<template>
    <div>
        <div class="map-header-text"> 
          <span @click="textlink1()" style="cursor:pointer;">全国</span><span v-html="'\u00a0'"></span>
          >
          <span v-html="'\u00a0'"></span><span @click="textlink2()" style="cursor:pointer;">{{this.$store.state.province}}</span><span v-html="'\u00a0'"></span>
          >
          <span v-html="'\u00a0'"></span><span style="cursor:pointer;">{{this.$store.state.city }}</span>
        </div>
      ...
      <el-divider></el-divider>
        <el-header style="
           text-align: left;
            ...
            margin-top: 15px;
            margin-bottom: 7px;
          ">{{$store.state.city}}网络安全事件概览</el-header>
...
import Xiangqing4 from "@/components/areaPage/xiangqing4.vue";
export default {
  name:'CityPage',
  data() {
    return {
