...
import Num from "@/components/countryPage/num.vue";
import Shejidanwei from "@/components/countryPage/shejidanwei.vue";
import Xiangqing from "@/components/countryPage/xiangqing.vue";
export default {
  name:'CountryPage',
  data() {
    return {
